...
\item A population of bacteria has an initial population of 200 bacteria. The population is growing at a rate of 4 \% per hour.
	\begin{enumerate}
	\item Write an exponential function $P(t)$ that relates the total population as a function of $t$ where the units of $t$ should be hours and the units of $P$ should be number of bacterial.
	\vfill
