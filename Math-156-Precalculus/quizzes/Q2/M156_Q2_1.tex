...
\restoregeometry
\begin{enumerate}
%1.4.52\input{M156_Q2_1.tex}

\item (4 points) Perform the addition and simplify: \scalebox{1.4}{$\frac{x}{x^2-4}+\frac{1}{x-2}.$}
\begin{flushright}{Answer: \underline{\hspace{2in}}}\end{flushright}

\vspace{1in}

%1.4.66
\item (4 points) Simply the compound fractional expression: \scalebox{1.4}{$\displaystyle{\frac{\frac{y}{x}+y}{\frac{x+y}{x}}}.$}
\begin{flushright}{Answer: \underline{\hspace{2in}}}\end{flushright}

\vspace{1in}

%1.4.20
\item (4 points) Simplify the rational expression \scalebox{1.4}{$\frac{x^2+4x+3}{x^2-2x-15}$}.\\
\begin{flushright}{Answer: \underline{\hspace{2in}}}\end{flushright}
...
\vfill
%1.5.94
\item (4 points) Find all real solutions to \scalebox{1.4}{$4-\sqrt{3x-1}=0$}.
\begin{flushright}{Answer: \underline{\hspace{2in}}}\end{flushright}
...
\vfill
%1.2.33
\item (3 points) Simplify  the expression \scalebox{1.4}{$\left(\frac{x^4}{7}\right)^2(4x^{-3})$}.
\begin{flushright}{Answer: \underline{\hspace{2in}}}\end{flushright}
