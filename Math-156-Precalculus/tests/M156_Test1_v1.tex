...
%%%%%%%%%%%%
%1.3(\#91-96)
\item (5 points) Factor the expression \scalebox{1.2}{$x(x+1)^{5/2}-x^2(x+1)^{3/2}$} completely by factoring out the lowest power of each common factor.
\begin{flushright}{ Answer:\underline{\hspace{2in}}}\end{flushright}
\vfill
%1.4(\#59-72) 
\item (5 points) Simplify the compound fraction \scalebox{1.2}{$ \frac{\frac{10}{y}+2}{\frac{x}{y}+\frac{y}{x}}$}
\begin{flushright}{ Answer:\underline{\hspace{2in}}}\end{flushright}
\vfill
%1.4(\#15-24)
...
\item (5 points) Find the domain of the function \scalebox{1.2}{$f(x)=\sqrt{(x-5)(x-3)}$}.\\
\begin{flushright}{ Answer:\underline{\hspace{2in}}}\end{flushright}
\vfill
\newpage
%%%%%%%%%%%%
