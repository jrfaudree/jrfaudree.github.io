...
The Final Exam will be given without the use of aids of any kind. You will have two hours to complete the test. The exam will cover Chapters 1-2, 4-12, 14. The majority of the problems will be proofs.  In some cases you will be asked to use a particular technique to prove a statement. In other instances it will be your choice what method to use. For all proofs you are expected to write complete, formal, appropriately detailed proofs.\\
...
You may bring one 3 by 5 notecard with writing on both sides.\\
...
%\item how to prove a function has an inverse and that two functions are or are not inverses
\item how to find the image or preimage of a set given a function
\item techniques to determine if two infinite sets do or do not have the same cardinality
\item techniques to determine if a set is or is not countable
\ee
\newpage
...
\begin{center} What the Exam Will Look Like \end{center}

\begin{itemize}
\item A statement you must prove by contrapositive.
\item A statement you must prove by contradiction.
\item A statement you must prove by induction.
\item A statement you must prove involving sets such as set containment or set equality.
\item A question about equivalence relations and equivalence classes
\item A question about functions being injective (or not) and surjective (or not)
\item A grab-bag short answer question
\end{itemize}
