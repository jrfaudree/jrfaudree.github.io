...
\item Review:
	...
	\begin{quote} 
	$\sim (P \vee Q)$ is equivalent to \underline{\hspace{2in}} \\
	
	\vspace{.2in}
	
	$\sim (P \wedge Q)$ is equivalent to \underline{\hspace{2in}} \\
	\end{quote}
...
\end{quote}
 ...
 \begin{tabular}{rlr}
 statement 1 & $=$ \: statement 2 & \quad  \quad because justification 1\\
 &$=$ \:  statement 3 & \quad because   justification 2\\
 &$=$  \: statement 4 &\quad because  justification 3\\
 \end{tabular}
