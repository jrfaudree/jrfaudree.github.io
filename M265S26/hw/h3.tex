...
\be
\item[A.] Let $A_n= \left( \frac{-1}{n}, \frac{1}{n} \right) \sse \R$ for $n \in \N.$ (For clarity, $A_n$ is an \textbf{interval} on the real line, not a point in the $xy$-plane.) Determine $\ds \bigcup_n^\infty A_n $ and $\ds \bigcap_n^\infty A_n $

\item[B.] Let $A_\alpha= \R - \alpha$ for $\alpha \in [0,1].$ Determine $\ds \bigcup_n^\infty A_n $ and $\ds \bigcap_n^\infty A_n $ 
