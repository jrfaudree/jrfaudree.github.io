...
Consider the infinite sets $S=\{1/2, 1/4, 1/16, 1/32, \cdots \}$ and $T=\{1/4, 1/16, 1/32, \cdots \}.$ How could you show that $|S|=|T|$? How can you use this idea to fill the hole at $x=1/2$?
\end{enumerate}
\end{document}