...
\vspace*{-0.7in}
\begin{center}
  \large \sc{Worksheet: (Review Week Day 1) Functions}
\end{center}
...
\item  Let $f(x) = 3x - \frac{1}{x} + 2.$ Find and simplify the following expressions. Are (b) and (c) different? 
